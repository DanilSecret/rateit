    ...
    return (
        <div>
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div
                    className="grid grid-cols-1 md:grid-cols-2 items-center bg-white shadow-md rounded-lg overflow-hidden mb-4">
                    <Image
                        src={product.image}
                        alt={product.name}
                        width={180}
                ...
                <div className="grid gap-4">
                    {Array.isArray(comments) && comments.length > 0 ? (
                        comments.map((comment) => (
                            <div key={comment.id} className="card bg-white shadow-md rounded-lg p-4">
